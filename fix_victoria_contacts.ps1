...
$newContactBlock = '<div class="contacts-contact">' +
  '<img class="contacts-contact-photo" src="/assets/images/team-victoria.png" style="filter:grayscale(1)">' +
  '<div>' +
    '<p class="contacts-contact-name">Victoria Svynobij</p>' +
    '<p>Producer</p><br>' +
...
$files = @(
  'C:\Users\kooro\Downloads\viziadigital.github.io-main\index.html',
  'C:\Users\kooro\Downloads\viziadigital.github.io-main\work\diia.html',
  'C:\Users\kooro\Downloads\viziadigital.github.io-main\work\dji-mini-3-pro.html',
  'C:\Users\kooro\Downloads\viziadigital.github.io-main\work\feed-up.html',
  'C:\Users\kooro\Downloads\viziadigital.github.io-main\work\kawasaki.html',
  'C:\Users\kooro\Downloads\viziadigital.github.io-main\work\lee-gardens-playdot.html',
  'C:\Users\kooro\Downloads\viziadigital.github.io-main\work\sms-food.html'
)

$pattern = '<div class="contacts-contact">.*?</div>\s*</div>'

foreach ($f in $files) {
  $t = [System.IO.File]::ReadAllText($f, [System.Text.Encoding]::UTF8)
  $newText = [regex]::Replace($t, $pattern, $newContactBlock, [System.Text.RegularExpressions.RegexOptions]::Singleline)
  if ($newText -ne $t) {
    [System.IO.File]::WriteAllText($f, $newText, [System.Text.Encoding]::UTF8)
    Write-Host "updated: $(Split-Path $f -Leaf)"
  } else {
    Write-Host "no match: $(Split-Path $f -Leaf)"
  }
}
